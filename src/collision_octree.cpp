#include "collision_octree.h"

void CollisionOctree::_ready() {
...
void CollisionOctree::insert(int _status, RID _body_rid, int64_t _instance_id, int _body_shape_index, int _area_shape_index, RID _area_rid) {
...
void CollisionOctree::split(OctreeNode* _node) {
...
void CollisionOctree::merge(OctreeNode* _node) {
...
void CollisionOctree::draw_debug() {
    if (!root_node) return;
...
void CollisionOctree::draw_debug_recursive(OctreeNode* _node) {
    if (!_node) return;
