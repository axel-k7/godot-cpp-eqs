...
class CollisionOctree : public Node3D {
	GDCLASS(CollisionOctree, Node3D)
...
public:
	static void _bind_methods() {
		ClassDB::bind_method(D_METHOD("insert", "_status", "_body_rid", "_instance_id", "_body_shape_index", "_area_shape_index", "_area_rid"), &CollisionOctree::insert);
		ClassDB::bind_method(D_METHOD("draw_debug"), &CollisionOctree::draw_debug);
		
		ClassDB::bind_method(D_METHOD("get_base_size"), &CollisionOctree::get_base_size);
		ClassDB::bind_method(D_METHOD("set_base_size", "value"), &CollisionOctree::set_base_size);
